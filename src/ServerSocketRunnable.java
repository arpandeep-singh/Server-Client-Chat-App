 ...
 * Purpose: Sends the response to the requests received from client
				...
				while (!done) {
					...
					if (inputString.startsWith("-")) {
						...
						case "time":
							...
							out.println(String.format("TIME: %2s:%2s:%2s %s", time.getHour()>12?"0"+(time.getHour()-12):time.getHour()<10?"0"+time.getHour():time.getHour(), time.getMinute()<10?"0"+time.getMinute():time.getMinute(),
